...
public class MainPage extends AnchorPane {
	...
	private ArrayList<ArrayList<Task>> getDateArray(ArrayList<Task> taskList) {
		...
		for (int i = START; i < taskList.size(); i++) {
			// checkIfNonFloatingTask(taskList, tempoDate, dateArray,
			// temporaryList, i);
			// temporaryList = checkIfReachedFloatingTask(taskList, tempoDate,
			// dateArray, temporaryList, i);
	 ...
	 */
	// private void checkIfNonFloatingTask(ArrayList<Task> taskList, String
	// tempoDate,
	// ArrayList<ArrayList<Task>> dateArray, ArrayList<Task> temporaryList, int
	// i) {
	// if (!(taskList.get(i) instanceof FloatingTask) && tempoDate != null) {
	// if
	// (tempoDate.equals(FORMAT_DATE.format(taskList.get(i).getEndDate().getTime())))
	// {
	// temporaryList.add(taskList.get(i));
	// } else {
	// assert
	 ...
	 * floating task
	 */
	// private ArrayList<Task> checkIfReachedFloatingTask(ArrayList<Task>
	// taskList, String tempoDate,
	// ArrayList<ArrayList<Task>> dateArray, ArrayList<Task> temporaryList, int
	// i) {
	// if ((taskList.get(i) instanceof FloatingTask) && tempoDate != null) {
	// dateArray.add(temporaryList);
